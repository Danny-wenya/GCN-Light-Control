...
def parse_cityflow_config(args, configname, simulate_time_changable = False,cityflow_config_modify = ''):
...
def parse_args(input_args = sys.argv):
    ...
    parser.add_argument('--test-round', type=int, default=0, help=
                        ...
                        'show result.')
    parser.add_argument('--dqn-split-model', action='store_true', default=False)
    ...
    parser.add_argument('-rm', '--clean-logs', action='store_true', default=False)
    parser.add_argument('-rmf', '--force-clean', action='store_true', default=False)
    ...
    parser.add_argument('--NM-phase-loss-with-replay', action='store_true', default=False)
    ...
    parser.add_argument('-dev', '--development', action='store_true', 
                        default=False)
    parser.add_argument('--save-lane-count-step', type=int, default=12)
    ...
    parser.add_argument('-Du', '--dqn-net-update-freq', type=int, default=10)
    ...
    parser.add_argument('--first_layer_embedding_size', type=int, default=64)
    parser.add_argument('--out_layer_dim', type=int, default=64)
    parser.add_argument('--strides', type=int, default=4)
    parser.add_argument('--temporal_emb', action='store_true', default=True)
    parser.add_argument('--spatial_emb', action='store_true', default=True)
    ...
    parser.add_argument('--hidden_dims',default=[])

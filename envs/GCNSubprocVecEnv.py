...
import time
import os
from .CityFlowEnv import CityFlowEnv
from .GCNCityFlowEnv import GCNCityFlowEnv
...
def getGCNCityFlowEnvVec(number, logpath, workpath, config, seed = 0, log = '',**kwargs):
    ...
    kwargs.update({"env_class":GCNCityFlowEnv,
                   "n_envs":number,
                   "env_args":env_args,
                   "is_args_list":True})

    return GCNEnvVecs(**kwargs)
